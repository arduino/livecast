/*
    Control a RGB LED with a phototransistor
    
    Map the values of a phototransistors to control
    an RGB LED, using multiple if statements
    
    (c) Karl, Josefine and Davide for Arduino, 2018
*/
